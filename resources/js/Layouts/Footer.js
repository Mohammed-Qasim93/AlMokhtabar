            ...
            <div className="w-full h-full flex flex-col justify-between px-6 py-4 bg-white shadow-md mt-16 overflow-hidden sm:rounded-lg">
                <div className="flex p-4 items-center justify-around">
                    <div className="flex flex-col justify-start">
                        ...
                        <div className="text-center">
                            <p>Love your self</p>
                            <p>All rights reserved &copy; to Almokhtabar Labs {(new Date().getFullYear())}</p>
                        </div>
                    </div>
                    <div className="flex flex-col gap-4 justify-center capitalize">
                        <p>HorizonDev tech support</p>
                        <div className="flex items-center justify-center gap-4">
                            <a href="https://www.instagram.com/horizondev.iq/">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="currentColor"
                                    className="bi bi-instagram w-8 h-8"
                                    viewBox="0 0 16 16"
                                >
                            ...
                            <a href="https://www.facebook.com/Horizon.Dev.IQ">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="currentColor"
                                    className="bi bi-facebook w-8 h-8"
                                    viewBox="0 0 16 16"
                                >
                ...
                <div className=" border-t-2 w-full bottom-0">
                    <div className="flex p-4 justify-center items-center gap-x-1">
                        ...
                        <a className="text-blue-500 underline" target="_blank" href="https://horizondev-7ul7z3h2p-mohammed-qasim93.vercel.app/">
                            {" "}
                            HorizonDev{" "}
                        </a>
                    </div>
