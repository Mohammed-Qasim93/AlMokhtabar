...
export default function Result({ report }) {
    return (
        <>
            ...
            <Head title={`Result of ${report.pname} test`} />
            <div className="flex flex-col">
                <div className="flex-1 flex flex-col ">
                    <div className=" flex justify-center relative text-gray-900 text-2xl">
                        <div className=" w-full fixed saturate-50 -z-10 top-0 left-0 opacity-50">
                            <img src={bg} alt="bg" />
                        </div>
                            ...
                            <div className="flex p-5 rounded-lg flex-col items-center sm:w-3/4 w-full h-[400px] bg-white shadow-sm justify-center gap-y-8">
                                <ul className="list-disc capitalize">
                                    <li className="">
                                        ...
                                        <a
                                            href={`/print?id=${report.patientid}.pdf`}
                                            className="text-red-500 font-tajawal-bold"
                                        >
                                            (open result{" "}
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                fill="red"
                                                className="bi bi-file-pdf w-6 h-5 inline"
                                                viewBox="0 0 16 16"
                                            >
